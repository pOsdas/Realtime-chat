"""
taken from https://github.com/pOsdas/useful-utilities/blob/master/utils/ensure_db.py
"""
...
def run_migrations():
    ...
    subprocess.run([sys.executable, "manage.py", "migrate", "chat_app", "--noinput"], check=True)
